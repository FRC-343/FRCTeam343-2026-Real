...
public class LowerShooterIOTalonFx implements LowerShooterIO {
  ...
  public LowerShooterIOTalonFx(int deviceId, int deviceId2, boolean isInverted) {
    ...
    talon
        ...
        .apply(
            new TalonFXConfiguration()
                ...
                .withSlot0(
                    new Slot0Configs().withKV(.12).withKP(.1).withKI(0).withKD(0.0).withKS(1.2)));
    follower
        .getConfigurator()
        .apply(
            new TalonFXConfiguration()
