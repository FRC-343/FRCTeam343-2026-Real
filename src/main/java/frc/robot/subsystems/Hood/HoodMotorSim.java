...
public class HoodMotorSim implements HoodMotorIO {
  ...
  public HoodMotorSim(DCMotor motorModel, double reduction, double moi, PIDConstants pidConstants) {
    sim =
  ...
  @Override
  public void setHoodVelocity(double voltage) {
