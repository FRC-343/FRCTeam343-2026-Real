...
public class HubLookUpTable {
  ...
  private void initializeLookupTable() {
    ...
    addEntry(1.2918881366663453, 32, 15.0, 1.01); // Close shot - nearly straight up
    addEntry(1.9090784403273822, 34, 20.0, 1.05);
    addEntry(2.3142050789213524, 36, 20, 1.20);
    addEntry(2.675989044663924, 37, 21.0, 1.31);
    addEntry(2.996659807285883, 38.0, 21, 1.20);
    addEntry(3.311555441242927, 39, 21.5, 1.21);
    addEntry(4.151147899829032, 40, 22.5, 1.41);
    addEntry(5.427651714921544, 42, 25.0, 1.35);
