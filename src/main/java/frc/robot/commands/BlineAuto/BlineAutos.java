...
public class BlineAutos {
  ...
  public static Command SanityCheck(Drive drive) {
    return Commands.sequence(
        Commands.waitSeconds(1),
        drive.pathBuilder().build(SanityCheck),
  ...
  public static Command trenchShoot(
    ...
    Path RPT = new Path(RightPathTwo);
    Path RightLeave = new Path("RightLeave");
    Path BumpcrossingTest = new Path("RightBumpCrossing");
    RPO.mirror();
    RPT.mirror();
    RightLeave.mirror();
    BumpcrossingTest.mirror();
      ...
      return Commands.sequence(
          ...
          Commands.parallel(
              ...
              Commands.sequence(
                  ...
                  drive.pathBuilder().build(RPO),
                  Commands.waitSeconds(bumpOneWait),
                  drive.pathBuilder().build(BumpcrossingTest),
                  Commands.parallel(
                      DriveCommands.pointAtAngle(
                              drive, () -> Rotation2d.fromDegrees(BobotState.getSolutionAngle()))
                          .withTimeout(3.5),
    ...
    return Commands.sequence(
        ...
        Commands.parallel(
            ...
            Commands.sequence(
                ...
                drive.pathBuilder().build(DepotEat),
